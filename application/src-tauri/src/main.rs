...
pub fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            core::authserver_commands::check_authlib_injector_status,
            core::authserver_commands::download_authlib_injector,
            core::authserver_commands::instance_uses_ms_account,
            core::authserver_commands::get_authlib_injector_path,
            core::authserver_commands::validate_ms_account_login,
