...
// Ice theme (free) - Cool blue tones
export const iceTheme: ThemeDefinition = {
  id: 'ice',
  name: 'Ice',
  description: 'Un tema fresco con tonos azules helados',
  author: 'ModpackStore',
  version: '1.0.0',
  isPremium: false,
  colors: {
    ...
    destructive: 'oklch(0.704 0.191 22.216)',
    border: 'oklch(0.9 0.03 240 / 10%)',
    input: 'oklch(0.9 0.03 240 / 15%)',
    ring: 'oklch(0.6 0.1 230)',
    chart1: 'oklch(0.6 0.15 230)',
    chart2: 'oklch(0.7 0.12 210)',
    chart3: 'oklch(0.65 0.13 250)',
    chart4: 'oklch(0.55 0.18 220)',
    chart5: 'oklch(0.75 0.10 200)',
    ...
    sidebarAccent: 'oklch(0.3 0.04 240)',
    sidebarAccentForeground: 'oklch(0.98 0.01 240)',
    sidebarBorder: 'oklch(0.9 0.03 240 / 10%)',
    sidebarRing: 'oklch(0.6 0.1 230)',
  },
};
