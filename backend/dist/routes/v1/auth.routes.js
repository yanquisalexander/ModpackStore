 ...
 *               $ref: '#/components/schemas/JsonApiErrorResponse'
 */
authRoutes.get('/discord/callback', Accounts_controller_1.AccountsController.callbackDiscord);
/**
 * @openapi
 * /auth/refresh:
 *   post:
 ...
 *               $ref: '#/components/schemas/JsonApiErrorResponse'
 */
authRoutes.post('/refresh', Accounts_controller_1.AccountsController.refreshTokens);
/**
 * @openapi
 * /auth/me:
 *   get:
...
authRoutes.get('/me', auth_middleware_1.requireAuth, Accounts_controller_1.AccountsController.getCurrentUser);
